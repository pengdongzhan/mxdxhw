...
public class PersonServiceImpl implements PersonService.Iface{
    ...
    @Override
    public void savePerson(Person person) throws DataException, TException,SQLException{
        ...
        try {
                ...
                if (h.next()) {
                    ...
                    String sql = "insert into USER(id,userName,password) values ('" + "3" + "','" + person.getUsername() + "','" + person.getAge() + "')";
                    num = st.executeUpdate(sql);
