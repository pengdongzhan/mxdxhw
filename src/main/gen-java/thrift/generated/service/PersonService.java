...
public class PersonService {
  ...
  public interface Iface {
    ...
    public int deletePerson(String username) throws DataException, org.apache.thrift.TException;

    public java.util.List<Person> getAllPerson() throws DataException, org.apache.thrift.TException;

    public Person userLogin(Person person) throws DataException, org.apache.thrift.TException;
  ...
  public interface AsyncIface {
    ...
    public void deletePerson(String username, org.apache.thrift.async.AsyncMethodCallback<Integer> resultHandler) throws org.apache.thrift.TException;

    public void getAllPerson(org.apache.thrift.async.AsyncMethodCallback<java.util.List<Person>> resultHandler) throws org.apache.thrift.TException;

    public void userLogin(Person person, org.apache.thrift.async.AsyncMethodCallback<Person> resultHandler) throws org.apache.thrift.TException;
  ...
  public static class Client extends org.apache.thrift.TServiceClient implements Iface {
    ...
    public void send_deletePerson(String username) throws org.apache.thrift.TException
    {
    ...
    public java.util.List<Person> recv_getAllPerson() throws DataException, org.apache.thrift.TException
    {
    ...
    public Person userLogin(Person person) throws DataException, org.apache.thrift.TException
    {
      send_userLogin(person);
      return recv_userLogin();
    }

    public void send_userLogin(Person person) throws org.apache.thrift.TException
    {
    ...
    public Person recv_userLogin() throws DataException, org.apache.thrift.TException
    {
  ...
  public static class AsyncClient extends org.apache.thrift.async.TAsyncClient implements AsyncIface {
    ...
    public static class deletePerson_call extends org.apache.thrift.async.TAsyncMethodCall<Integer> {
      private String username;
      public deletePerson_call(String username, org.apache.thrift.async.AsyncMethodCallback<Integer> resultHandler, org.apache.thrift.async.TAsyncClient client, org.apache.thrift.protocol.TProtocolFactory protocolFactory, org.apache.thrift.transport.TNonblockingTransport transport) throws org.apache.thrift.TException {
        super(client, protocolFactory, transport, resultHandler, false);
        this.username = username;
      }
    ...
    public static class getAllPerson_call extends org.apache.thrift.async.TAsyncMethodCall<java.util.List<Person>> {
      public getAllPerson_call(org.apache.thrift.async.AsyncMethodCallback<java.util.List<Person>> resultHandler, org.apache.thrift.async.TAsyncClient client, org.apache.thrift.protocol.TProtocolFactory protocolFactory, org.apache.thrift.transport.TNonblockingTransport transport) throws org.apache.thrift.TException {
        super(client, protocolFactory, transport, resultHandler, false);
      }
      ...
      public java.util.List<Person> getResult() throws DataException, org.apache.thrift.TException {
        if (getState() != State.RESPONSE_READ) {
          throw new IllegalStateException("Method call not finished!");
        }
        org.apache.thrift.transport.TMemoryInputTransport memoryTransport = new org.apache.thrift.transport.TMemoryInputTransport(getFrameBuffer().array());
    ...
    public void userLogin(Person person, org.apache.thrift.async.AsyncMethodCallback<Person> resultHandler) throws org.apache.thrift.TException {
      checkReady();
      userLogin_call method_call = new userLogin_call(person, resultHandler, this, ___protocolFactory, ___transport);
      this.___currentMethod = method_call;
      ___manager.call(method_call);
    }

    public static class userLogin_call extends org.apache.thrift.async.TAsyncMethodCall<Person> {
      private Person person;
      public userLogin_call(Person person, org.apache.thrift.async.AsyncMethodCallback<Person> resultHandler, org.apache.thrift.async.TAsyncClient client, org.apache.thrift.protocol.TProtocolFactory protocolFactory, org.apache.thrift.transport.TNonblockingTransport transport) throws org.apache.thrift.TException {
        super(client, protocolFactory, transport, resultHandler, false);
        this.person = person;
      }
  ...
  public static class Processor<I extends Iface> extends org.apache.thrift.TBaseProcessor<I> implements org.apache.thrift.TProcessor {
    ...
    public static class userLogin<I extends Iface> extends org.apache.thrift.ProcessFunction<I, userLogin_args> {
      ...
      public userLogin_result getResult(I iface, userLogin_args args) throws org.apache.thrift.TException {
        userLogin_result result = new userLogin_result();
        try {
          result.success = iface.userLogin(args.person);
        } catch (DataException dateException) {
          result.dateException = dateException;
        }
        return result;
  ...
  public static class AsyncProcessor<I extends AsyncIface> extends org.apache.thrift.TBaseAsyncProcessor<I> {
    ...
    public static class deletePerson<I extends AsyncIface> extends org.apache.thrift.AsyncProcessFunction<I, deletePerson_args, Integer> {
      public deletePerson() {
        super("deletePerson");
      }
      ...
      public void start(I iface, deletePerson_args args, org.apache.thrift.async.AsyncMethodCallback<Integer> resultHandler) throws org.apache.thrift.TException {
        iface.deletePerson(args.username,resultHandler);
      }
    }

    public static class getAllPerson<I extends AsyncIface> extends org.apache.thrift.AsyncProcessFunction<I, getAllPerson_args, java.util.List<Person>> {
      public getAllPerson() {
        super("getAllPerson");
      }
      ...
      public void start(I iface, getAllPerson_args args, org.apache.thrift.async.AsyncMethodCallback<java.util.List<Person>> resultHandler) throws org.apache.thrift.TException {
        iface.getAllPerson(resultHandler);
      }
    }

    public static class userLogin<I extends AsyncIface> extends org.apache.thrift.AsyncProcessFunction<I, userLogin_args, Person> {
      public userLogin() {
        super("userLogin");
      }
      ...
      public void start(I iface, userLogin_args args, org.apache.thrift.async.AsyncMethodCallback<Person> resultHandler) throws org.apache.thrift.TException {
        iface.userLogin(args.person,resultHandler);
      }
    }
  ...
  public static class deletePerson_args implements org.apache.thrift.TBase<deletePerson_args, deletePerson_args._Fields>, java.io.Serializable, Cloneable, Comparable<deletePerson_args>   {
    ...
    public deletePerson_args setUsername(@org.apache.thrift.annotation.Nullable String username) {
      this.username = username;
      return this;
    }
...
;
    ...
    @Override
    public String toString() {
      StringBuilder sb = new StringBuilder("getAllPerson_args(");
      boolean first = true;
  ...
  public static class getAllPerson_result implements org.apache.thrift.TBase<getAllPerson_result, getAllPerson_result._Fields>, java.io.Serializable, Cloneable, Comparable<getAllPerson_result>   {
    ...
    public getAllPerson_result setSuccess(@org.apache.thrift.annotation.Nullable java.util.List<Person> success) {
      this.success = success;
      return this;
    }
    ...
    @Override
    public String toString() {
      StringBuilder sb = new StringBuilder("getAllPerson_result(");
      boolean first = true;
  ...
  public static class userLogin_args implements org.apache.thrift.TBase<userLogin_args, userLogin_args._Fields>, java.io.Serializable, Cloneable, Comparable<userLogin_args>   {
    ...
    public userLogin_args setPerson(@org.apache.thrift.annotation.Nullable Person person) {
      this.person = person;
      return this;
    }
  ...
  public static class userLogin_result implements org.apache.thrift.TBase<userLogin_result, userLogin_result._Fields>, java.io.Serializable, Cloneable, Comparable<userLogin_result>   {
    ...
    public userLogin_result setSuccess(@org.apache.thrift.annotation.Nullable Person success) {
      this.success = success;
      return this;
    }
    ...
    public userLogin_result setDateException(@org.apache.thrift.annotation.Nullable DataException dateException) {
      this.dateException = dateException;
      return this;
    }
